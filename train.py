    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if RANK in {-1, 0}:
                ...
                #写入epoch，gpu_mem，box，obj，cls，labels，img_size的值，其中*mloss表示box，obj，cls这三个参数，*表示元组（tuple），**表示字典（dict）
                #带 * 表示参数的个数不止一个
...
def parse_opt(known=False):
    ...
    parser.add_argument('--name', default='exp_XC2', help='save to project/name')
